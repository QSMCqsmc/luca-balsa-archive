...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderTalentPlan(planId) {
    ...
    document.querySelector("#talent-image-path").textContent = plan.image;
    talentImage.classList.remove("media-error");
    talentPlaceholder.classList.remove("visible");
    talentImage.alt = `${plan.name}天赋图`;
    talentImage.src = plan.image;
    if (talentImage.complete && talentImage.naturalWidth === 0) showTalentPlaceholder();
